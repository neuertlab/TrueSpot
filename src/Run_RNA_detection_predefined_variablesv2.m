...
function Run_RNA_detection_predefined_variablesv2(thA,ths,outfile_prefix_RNA,Yth,Ych,ManTh,Ywin,Yim,task_ids,file_type,exp_date,strain,osmo,genepair,file_end,exp_names,positions_touse,segment_mode,Seg_thres,fish_dir,outfile_prefix_seg,img_num,node_num)
%% Input
...
%         legend('scrambled probes CY5','no probes CY5','GPD1 CY5','scrambled probes AF594','no probes AF594','GPP2 AF594','scrambled probes TMR','no probes TMR','STL1 TMR')
       %%%%%%%%% 
       for channels1 = 1:(ch-2)
           if chi(channels1) ==  3
               thresh_img = CY5_ims;
           elseif chi(channels1) ==  4
               thresh_img = AF594_ims;
           elseif chi(channels1) ==  5
               thresh_img = TMR_ims;
           elseif chi(channels1) ==  6
               thresh_img = YFP_ims;

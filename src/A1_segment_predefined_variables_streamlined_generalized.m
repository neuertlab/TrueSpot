...
clear stack;
    ...
    if false %ManTh & Yth == 0 & exist([outfile_prefix_seg fileTH],'file'); % test if the file exist allready  %  
       load([outfile_prefix_seg fileTH],'dapi_threshold','dapi_label','DAPI_ims_added','dapi_label_low1','-mat')   % load the existing file
       ...
       save([outfile_prefix_seg fileTH],'dapi_threshold','dapi_label','DAPI_ims_added','dapi_label_low1','-mat');     % Save the segmented nuclei
    end;

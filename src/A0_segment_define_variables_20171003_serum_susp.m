...
positions_touse = { ...
 [1:5];... %  0min 4                                                        %Change each number to the range of image numbers each timepoint has
 [1:5];... %  1min 4
 [1:10];... %  2min 4
%  [1:4];... %  4min 4 
%  [1:4];... %  6min 6
...
if Ywin == 0;;
   ...
   outfile_prefix_RNA=strcat('C:\Users\keslerbk\Documents\2017-08-04 mESC Segmentation (20170525)\Seg\'); %[ A ]
end
...
%% Run the segmentation or RNA threshold determination
 ...
 if RNA_thres == 1
     Run_RNA_detection_predefined_variables(thA,ths,outfile_prefix_RNA,Yth,Ych,ManTh,Ywin,Yim,task_ids,file_type,exp_date,strain,osmo,genepair,file_end,exp_names,positions_touse,segment_mode,Seg_thres,fish_dir,outfile_prefix_seg,img_num,node_num)
 end   

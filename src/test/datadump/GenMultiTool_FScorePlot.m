...
function fig_handle = GenMultiTool_FScorePlot(img_results_obj, figno)
...
subplot(2,2,1);
fig_handle_temp = img_results_obj.renderFScorePlot('homebrew', [1.0 0.0 0.0], 1, figno, fig_handle);

...
Yim = 1;                                                                   % Show images of nucleus and trans segmentation
task_ids = [1:2];                                                          %Set to how many timepoints there are.

%Only need to change if different organism. 
...
positions_touse = { ...
 [1:7];... %  0min 4                                                        %Change each number to the range of image numbers each timepoint has
 [1:6];... %  1min 4
 [1:10];... %  2min 4
%  [1:4];... %  4min 4 
%  [1:4];... %  6min 6
